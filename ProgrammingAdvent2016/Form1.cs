...
namespace ProgrammingAdvent2016
{
    public partial class Form1 : Form
    {
        ...
        readonly string[] inputFilePaths = new string[] { "",
            ...
            @"InputFiles\InputDay18.txt",
            @"InputFiles\InputDay19.txt",
            @"InputFiles\InputDay20.txt",
            @"InputFiles\InputDay21.txt",
            @"InputFiles\InputDay22.txt",
            @"InputFiles\InputDay23.txt",
            @"InputFiles\InputDay24.txt",
            @"InputFiles\InputDay25.txt" };
        ...
        public void ClickAllButtons()
        {
            ...
            if (buttonDay18.Enabled) ButtonDay18_Click(null, null);
            if (buttonDay19.Enabled) ButtonDay19_Click(null, null);
            if (buttonDay20.Enabled) ButtonDay20_Click(null, null);
            if (buttonDay21.Enabled) ButtonDay21_Click(null, null);
            if (buttonDay22.Enabled) ButtonDay22_Click(null, null);
            if (buttonDay23.Enabled) ButtonDay23_Click(null, null);
            if (buttonDay24.Enabled) ButtonDay24_Click(null, null);
            if (buttonDay25.Enabled) ButtonDay25_Click(null, null);
        }
        ...
        private void ButtonDay18_Click(object sender, EventArgs e)
        {
            DayButtonClicked_Async(18);
        }

        private void ButtonDay19_Click(object sender, EventArgs e)
        {
            DayButtonClicked_Async(19);
        }

        private void ButtonDay20_Click(object sender, EventArgs e)
        {
            DayButtonClicked_Async(20);
        }

        private void ButtonDay21_Click(object sender, EventArgs e)
        {
            DayButtonClicked_Async(21);
        }

        private void ButtonDay22_Click(object sender, EventArgs e)
        {
            DayButtonClicked_Async(22);
        }

        private void ButtonDay23_Click(object sender, EventArgs e)
        {
            DayButtonClicked_Async(23);
        }

        private void ButtonDay24_Click(object sender, EventArgs e)
        {
            DayButtonClicked_Async(24);
        }

        private void ButtonDay25_Click(object sender, EventArgs e)
        {
            DayButtonClicked_Async(25);
        }
        #endregion
    }
}
